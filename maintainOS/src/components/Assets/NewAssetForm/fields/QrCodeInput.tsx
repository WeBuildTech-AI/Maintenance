...
export function QrCodeInput() {
  ...
  return (
    <div className="mt-4">
      <label className="mb-2 block text-sm font-medium text-gray-900">QR Code/Barcode</label>
      <input
        type="text"
        value={qrCodeValue}
      ...
      <div className="mt-2">
        ...
        <span className="text-blue-600 text-sm cursor-pointer hover:underline">Generate Code</span>
      </div>
    </div>
  );
}
