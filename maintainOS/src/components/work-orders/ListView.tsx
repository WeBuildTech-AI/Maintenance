...
// const mapAntSortOrder = (order: string) => (order === "asc" ? "ascend" : "descend");
...
//     dataIndex: "id",
//     width: 120,
//     sorter: (a: { id: any; }, b: { id: any; }) => (a.id || "").localeCompare(b.id || ""),
//   },
//   Status: {
//     dataIndex: "status",
//     width: 150,
//     sorter: (a: { status: any; }, b: { status: any; }) => (a.status || "").localeCompare(b.status || ""),
//   },
//   Priority: {
//     dataIndex: "priority",
//     width: 130,
//     sorter: (a: { priority: any; }, b: { priority: any; }) => (a.priority || "").localeCompare(b.priority || ""),
//   },
//   "Work Type": {
//     dataIndex: "workType",
//     width: 150,
//     sorter: (a: { workType: any; }, b: { workType: any; }) => (a.workType || "").localeCompare(b.workType || ""),
//   },
//   "Assigned To": {
//     dataIndex: "assignedTo",
//     width: 170,
//     sorter: (a: { assignedTo: any; }, b: { assignedTo: any; }) => (a.assignedTo || "").localeCompare(b.assignedTo || ""),
//   },
//   Categories: {
//     dataIndex: "categories",
//     width: 150,
//     sorter: (a: { categories: any; }, b: { categories: any; }) => (a.categories || "").localeCompare(b.categories || ""),
//   },
//   Asset: {
//     dataIndex: "asset",
//     width: 150,
//     sorter: (a: { asset: any; }, b: { asset: any; }) => (a.asset || "").localeCompare(b.asset || ""),
//   },
//   Location: {
//     dataIndex: "location",
//     width: 150,
//     sorter: (a: { location: any; }, b: { location: any; }) => (a.location || "").localeCompare(b.location || ""),
//   },
//   "Created On": {
//     dataIndex: "createdOn",
//     width: 150,
//     sorter: (a: { createdOn: string | number | Date; }, b: { createdOn: string | number | Date; }) =>
//       new Date(a.createdOn).getTime() - new Date(b.createdOn).getTime(),
//   },
//   "Updated On": {
//     dataIndex: "updatedOn",
//     width: 150,
//     sorter: (a: { updatedOn: string | number | Date; }, b: { updatedOn: string | number | Date; }) =>
...
//   const handleApplySettings = (settings: { visibleColumns: React.SetStateAction<string[]>; showDeleted: boolean | ((prevState: boolean) => boolean); }) => {
...
//       sorter: (a: { title: any; }, b: { title: any; }) => (a.title || "").localeCompare(b.title || ""),
//       sortOrder: sortType === "title" ? mapAntSortOrder(sortOrder) : undefined,

//       render: (title: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined, record: { id: string; full: React.SetStateAction<null>; }) => {
...
//         if (colName === "Status") {
//           renderFunc = (status: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined) => <Badge variant="secondary">{status}</Badge>;
...
//       render: (text: any, record: { full: React.SetStateAction<null>; title: string; }) => (
...
const mapAntSortOrder = (order) => (order === "asc" ? "ascend" : "descend");
  ...
  const columns = useMemo(() => {
    ...
    const dynamicColumns = visibleColumns
      ...
      .map((colName) => {
        ...
        // Apply special render functions for Status, Created On, Updated On
        if (colName === "Status") {
          renderFunc = (status) => <Badge variant="secondary">{status}</Badge>;
        } else if (colName === "Created On" || colName === "Updated On") {
          renderFunc = (text) => formatTableDate(text);
        }
    ...
    // ACTION COLUMN IS REMOVED as requested.
