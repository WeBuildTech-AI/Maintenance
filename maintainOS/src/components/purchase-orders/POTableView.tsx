...
export default function PurchaseOrdersTable({ orders, columns, pageSize }: PurchaseOrdersTableProps) {
  ...
  return (
    <div className="border rounded-lg shadow-sm bg-white flex flex-col h-full">
        ...
        <div className="flex-1 overflow-auto">
            <table className="table-auto w-full text-sm">
                ...
                <tr>
                    <th className="px-4 py-4 text-left w-10">
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setSelectedPOs((prev) => Array.from(new Set([...prev, ...allIds])));
                                } else {
                                setSelectedPOs((prev) =>
                    ...
                    <th
                        key={col.key}
                        className="px-4 py-4 text-left font-medium text-gray-700 cursor-pointer select-none"
                ...
                {visibleOrders.length > 0 ? (
                    ...
                    >
                        ...
                        switch (col.key) {
                            case "title":
                            return (
                                <td key={col.key} className="px-4 py-3 flex items-center gap-3">
                            ...
                            case "id":
                            return (
                                <td key={col.key} className="px-4 py-3 font-mono text-gray-700">
                                #{order.id}
                                </td>
                            );
                            case "vendor":
