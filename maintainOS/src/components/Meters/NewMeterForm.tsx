      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        ...
        <div className="px-6 pt-6">
          <div className="flex items-start gap-4">
            <div className="mt-2 flex h-7 w-7 flex-none items-center justify-center rounded-full border bg-white text-gray-400">
        ...
        <div className="px-6 pb-6 pt-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-md border px-4 py-2 text-sm font-medium transition-colors ${
                meterType === "automated"
                  ? "border-orange-600 text-orange-600 ring-1 ring-blue-500/20"
                  : "border-gray-300 text-gray-700 hover:bg-gray-50"
              }`}
            >
        ...
        <div className="px-6 pb-24 pt-6">
          ...
          {/* Upload Box */}
          <div className="mb-20 border border-dashed rounded-md p-6 text-center bg-blue-50 text-orange-600 cursor-pointer">
