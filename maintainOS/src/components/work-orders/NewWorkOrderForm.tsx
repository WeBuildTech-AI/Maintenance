            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
                <div className="px-6 pt-6">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-4">{/* changed mt-5 → mt-8 */}
                            <button className="flex items-center gap-2 text-blue-600 text-sm cursor-pointer hover:text-blue-800 transition-colors">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center items-center">
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 px-8 h-20 text-sm font-semibold text-blue-500 bg-white border border-blue-500 rounded-md"
                                >
                                    {/* Plus icon */}
                                    <svg
                                        className="w-5 h-5"
