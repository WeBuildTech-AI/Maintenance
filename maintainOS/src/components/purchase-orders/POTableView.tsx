            ...
            <tr>
              <th className="px-4 py-2 text-left w-10">
                <input
                  ...
                  className="cursor-pointer mt-2 accent-blue-600 h-4 w-4"
                />
              </th>
              {columns.map((col) => (
                <th
                  key={col.key}
                  className="px-2 py-2 text-left font-medium text-gray-700 cursor-pointer select-none overflow-auto"
