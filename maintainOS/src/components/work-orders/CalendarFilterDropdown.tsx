...
export function CalendarFilterDropdown({ onClose, onApply, assets = [], locations = [] }: CalendarFilterDropdownProps) {
    ...
    return (
        <div className="absolute top-[110%] left-0 z-50 flex w-[620px] h-[340px] flex-col rounded-[10px] border border-gray-200 bg-white shadow-xl animate-in fade-in zoom-in-95 duration-100">
