...
export function NewAssetForm({ onCreate }: NewAssetFormProps) {
  ...
  const [selectedVendor, setSelectedVendor] = useState<{ name: string } | null>(
    null
  );
    ...
    <div className="flex h-full flex-col overflow-hidden rounded-lg border">
      ...
      <div className="sticky bottom-0 mt-6 flex items-center border-t bg-white px-6 py-4">
        <button
          ...
          className="h-10 rounded-md bg-orange-600 text-sm font-medium text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          Create
        </button>
      </div>
